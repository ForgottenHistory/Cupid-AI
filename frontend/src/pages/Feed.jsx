...
const Feed = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 flex flex-col overflow-hidden">
      {/* Header */}
      <div className="bg-white/60 backdrop-blur-md shadow-sm border-b border-purple-100/50">
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        {error && (
          <div className="absolute top-4 left-1/2 transform -translate-x-1/2 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg">
            {error}
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm">Characters will start posting soon!</p>
          </div>
        ) : (
          <>
            {/* Main Post Container */}
            <div className="max-w-5xl w-full h-full flex items-center">
              <div
                className={`bg-white/60 backdrop-blur-sm rounded-3xl shadow-xl border border-purple-100/50 overflow-hidden w-full h-full max-h-[600px] flex transition-all duration-300 ease-out ${
              ...
              >
                ...
                <div className="flex-1 p-8 flex flex-col overflow-y-auto">
                  ...
                  <div className="mb-6">
                    <h2
                      className="text-2xl font-bold text-gray-900 hover:text-purple-600 transition-colors cursor-pointer mb-1"
                      onClick={() => handleCharacterClick(currentPost.character_id)}
                    >
            ...
            {currentIndex > 0 && (
              <button
                ...
                className="absolute left-8 top-1/2 transform -translate-y-1/2 bg-white/80 backdrop-blur-sm hover:bg-white border border-purple-100 text-purple-600 rounded-full p-4 shadow-lg transition-all hover:scale-110"
              >
            ...
            {currentIndex < posts.length - 1 && (
              <button
                onClick={handleNext}
                className="absolute right-8 top-1/2 transform -translate-y-1/2 bg-white/80 backdrop-blur-sm hover:bg-white border border-purple-100 text-purple-600 rounded-full p-4 shadow-lg transition-all hover:scale-110"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
