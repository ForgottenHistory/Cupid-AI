...
const PostInstructionsModal = ({ isOpen, onClose, characterId, characterName, onSave }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 overflow-y-auto custom-scrollbar">
      ...
      {/* Modal */}
      <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] my-auto overflow-y-auto custom-scrollbar border border-purple-200/50 dark:border-purple-800/50 flex flex-col">
        {/* Header */}
