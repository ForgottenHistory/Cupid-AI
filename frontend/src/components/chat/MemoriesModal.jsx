...
/**
 * Modal component to display character memories
 */
const MemoriesModal = ({ isOpen, onClose, characterName, memories, loading }) => {
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-400 dark:text-gray-500 mt-2">
                Memories are extracted from your conversations over time
              </p>
            </div>
          ) : (
