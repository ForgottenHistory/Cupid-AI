...
const BEHAVIOR_VALIDATION = {
  ...
  proactiveCheckIntervalMin: { min: 5, max: 300, error: 'Proactive check interval min must be between 5 and 300 minutes' },
  proactiveCheckIntervalMax: { min: 5, max: 300, error: 'Proactive check interval max must be between 5 and 300 minutes' },
  doubleTextChanceMin: { min: 0, max: 100, error: 'Double text chance min must be between 0 and 100' },
  doubleTextChanceMax: { min: 0, max: 100, error: 'Double text chance max must be between 0 and 100' },
...
const FIELD_TO_COLUMN = {
  ...
  proactiveCheckIntervalMin: 'proactive_check_interval_min',
  proactiveCheckIntervalMax: 'proactive_check_interval_max',
  doubleTextChanceMin: 'double_text_chance_min',
  doubleTextChanceMax: 'double_text_chance_max',
