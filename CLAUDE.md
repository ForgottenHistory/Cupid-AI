...
- **Services**:
  - `aiService.js` - Multi-provider LLM integration (OpenRouter/Featherless), system prompts, token counting/trimming, decision engine, Big Five personality generation
...
- **Log cleanup** (10-minute rolling window, runs every 60 seconds)
- **Bug fixes**: Provider selection, model deduplication, chat component remounting (key prop on route param)
...
- **Proactive messaging**: Time-gap detection, extraversion-based probability, 5/day limit
